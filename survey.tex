...
\newcommand{\thissubject}{A Survey of Multidimensional Visual Analysis Methods and Tools}  % subject
...
\newcommand{\thisdate}{1 Mar 2023}  % date of this version
...
% https://portal.issn.org/resource/ISSN/1467-8659
...
\ifpdf
{\smaller ISSN
\href{https://portal.issn.org/resource/ISSN/#1}{#1}}%
\else
{\smaller ISSN #1}%
\fi
}%
...
\end{center}
With the rise of Artificial Intelligence and Machine Learning, there is an
increasing amount of high-dimensional data available. Multidimensional
Visual Analysis (MVA) is a field that uses visual representations to
explore and analyze multi-dimensional datasets. 

This survey reviews multiple popular MVA approaches. Some of them are
scatter plots, similarity maps, parallel coordinates, brushing and
linking, and grouping and labelling.

The survey also reviews and compares some of the most popular MVA software
tools. The following tools are reviewed and compared: InfoScope, High-D,
GGobi, mVis, Improvise, MyBrush, XDAT, TabuVis, and Parallax.
\end{quote}
