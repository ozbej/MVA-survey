...
analysts visualize and analyze complex datasets. These programs typically
...
multi-dimensional datasets. This technique combines linked
...
Parallax
\parencites{avidan1999parallax}[Chapter~10]{inselberg2008parallel} is
a tool for effectively analyzing multidimensional datasets and
discovering patterns, properties, and relations in data. Parallax is
written in \emph{x} and is available as a commercial, closed-source
with the latest update issued on \emph{x}.
...
\caption[Comparison of MVA Tool Features]
{%
Comparison of MVA tool features.
}
