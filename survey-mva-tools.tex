...
\caption[High-D]
{%
High-D displaying the \emph{Premier League Player Stats} dataset.
}
...
\caption[GGobi]
{%
GGobi displaying the \emph{Premier League Player Stats} dataset.
}
...
\caption[XDAT]
{%
XDAT displaying the \emph{Premier League Player Stats} dataset.
}
...
\caption[TabuVis]
{%
TabuVis displaying the \emph{Premier League Player Stats} dataset.
}
